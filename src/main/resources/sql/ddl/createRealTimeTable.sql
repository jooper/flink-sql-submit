...
(
  ...
  health_service_org_id          VARCHAR default 'RSS20110919001863000' not null,
  department_id                  VARCHAR,
  doctor_id                      VARCHAR,
  clinic_dept_id                 VARCHAR,
  diag_room_id                   VARCHAR,
  registrator                    VARCHAR,
  ...
  patient_caliber                VARCHAR,
  queue_type_id                  VARCHAR,
  dqc_message                    VARCHAR2(200),
  is_received_nonum_visit_regfee CHAR(1),
  is_see_doctor                  CHAR(1) default '1',
  s_jbfl_dm                      VARCHAR,
  fin_cc_scheme_id               VARCHAR,
  s_scqd_dm                      VARCHAR,
  duty_date                      DATE not null,
  s_pkhsx_dm                     VARCHAR2(4),
  opd_sd_reg_id                  VARCHAR,
  is_gcp                         CHAR(1),
  timerange                      VARCHAR2(32),
  back_cause                     VARCHAR,
  is_jcs                         CHAR(1),
  opr_jcs_arr                    VARCHAR,
  clin_area_id                   VARCHAR,
  clindr_office_dept_id          VARCHAR,
  s_ylfkfs_dm                    VARCHAR2(2),
  is_expert                      CHAR(1),
  hosp_ref_pers_id               VARCHAR,
  sign_tm                        DATE
)
tablespace USERS
  pctfree 10
...
(
  ...
  health_service_org_id  VARCHAR default 'RSS20110919001863000',
...
(
  ...
  exec_dept_id             VARCHAR,
  exec_person_id           VARCHAR,
  out_patient_charge_type  VARCHAR2(2),
  invoice_no               VARCHAR,
  checkout_vouchar_no      VARCHAR2(30),
  diag_service_d_charge_id VARCHAR,
  package_qty              INTEGER,
  opc_diag_service_d_id    VARCHAR,
  primary_barcode          VARCHAR2(100),
  trace_barcode            VARCHAR2(100),
  ext_trans_code           VARCHAR2(30),
  discount_amt             NUMBER(15,8),
  pem_exam_chargeitem_id   VARCHAR,
  ...
  op_pers_id               VARCHAR,
  op_asst_i_pers_id        VARCHAR,
  op_asst_ii_pers_id       VARCHAR,
  op_kpi                   NUMBER(15,4),
  op_asst_i_kpi            NUMBER(15,4),
  op_asst_ii_kpi           NUMBER(15,4),
  s_fbdj_dm                VARCHAR2(2),
  use_fee_lvl              VARCHAR2(2),
  op_asst_iii_pers_id      VARCHAR,
  op_asst_iv_pers_id       VARCHAR,
...
(
  id                      VARCHAR not null,
  person_info_id          VARCHAR not null,
  ...
  s_hyzk_dm               VARCHAR2(2) not null,
  person_ident_id         VARCHAR,
  patient_type_id         VARCHAR not null,
  s_czbz_dm               VARCHAR2(1) default '1',
  health_service_org_id   VARCHAR default 'RSS20110919001863000' not null,
  registration_person_id  VARCHAR,
  registration_date       DATE,
  opc_registration_id     VARCHAR,
  opc_dept_id             VARCHAR,
  clinic_dept_id          VARCHAR,
  opc_doctor_id           VARCHAR,
  ipi_dept_id             VARCHAR not null,
  ipi_doctor_id           VARCHAR not null,
  dept_id                 VARCHAR,
  dept_director_id        VARCHAR,
  doctor_id               VARCHAR,
  nurse_id                VARCHAR,
  bed_id                  VARCHAR,
  bed_no                  VARCHAR2(10),
  ...
  s_ylfkfs_dm             VARCHAR2(2),
  ipi_reg_certificate_id  VARCHAR,
  ipi_reg_app_id          VARCHAR,
  is_pregnancy            CHAR(1),
  is_gcp                  CHAR(1),
  age_hh                  INTEGER,
  age_ss                  INTEGER,
  ...
  cur_mrb                 VARCHAR,
  s_scqd_dm               VARCHAR,
  workunit_province       VARCHAR,
  workunit_city           VARCHAR,
  workunit_area           VARCHAR,
  workunit                VARCHAR2(140),
  nativeplace_area        VARCHAR,
  inhospital_times        INTEGER,
  case_serialnumber       VARCHAR2(32),
  inhosp_way_othr         VARCHAR2(100),
  othr_hso_xfer           VARCHAR2(100),
  insection_dept_id       VARCHAR,
  insection_user_id       VARCHAR
)
tablespace USERS
  pctfree 10
  initrans 1
...
(
  ...
  hospital_area           VARCHAR,
  department_nature_name  VARCHAR2(50),
  hospital_area_name      VARCHAR2(50),
  op_income_dept_id       VARCHAR,
  ip_income_dept_id       VARCHAR,
...
(
  ...
  patient_type_id         VARCHAR not null,
  s_czbz_dm               VARCHAR2(1) default '1',
  health_service_org_id   VARCHAR not null,
  registration_person_id  VARCHAR,
  registration_date       DATE,
  opc_registration_id     VARCHAR,
  opc_dept_id             VARCHAR,
