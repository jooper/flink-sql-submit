...
(
  ...
  person_ident_id                VARCHAR2(200),
  patient_type_id                VARCHAR2(200),
  ...
  health_service_org_id          VARCHAR2(200) default 'RSS20110919001863000' not null,
  department_id                  VARCHAR2(200),
  doctor_id                      VARCHAR2(200),
  clinic_dept_id                 VARCHAR2(200),
  diag_room_id                   VARCHAR2(200),
  registrator                    VARCHAR2(200),
  identity_no                    VARCHAR2(70),
  registration_type              VARCHAR2(200),
  opc_registration_no            VARCHAR2(12),
  is_discount                    CHAR(1),
  s_brlx_dm                      VARCHAR2(2),
  registration_num               INTEGER,
  duty_setting                   VARCHAR2(200),
  other_identity_no              VARCHAR2(30),
  arrangement_id                 VARCHAR2(200),
  regestration_out_type          CHAR(1) default '1',
  is_visit                       CHAR(1) default '2',
  visit_times                    INTEGER,
  is_subsidies                   CHAR(1) default '2',
  patient_caliber                VARCHAR2(200),
  queue_type_id                  VARCHAR2(200),
  dqc_message                    VARCHAR2(200),
  is_received_nonum_visit_regfee CHAR(1),
  is_see_doctor                  CHAR(1) default '1',
  s_jbfl_dm                      VARCHAR2(200),
  fin_cc_scheme_id               VARCHAR2(200),
  s_scqd_dm                      VARCHAR2(200),
  duty_date                      DATE not null,
  s_pkhsx_dm                     VARCHAR2(4),
  opd_sd_reg_id                  VARCHAR2(200),
  is_gcp                         CHAR(1),
  timerange                      VARCHAR2(32),
  back_cause                     VARCHAR2(200),
  is_jcs                         CHAR(1),
  opr_jcs_arr                    VARCHAR2(200),
  clin_area_id                   VARCHAR2(200),
  clindr_office_dept_id          VARCHAR2(200),
  s_ylfkfs_dm                    VARCHAR2(2),
  is_expert                      CHAR(1),
  hosp_ref_pers_id               VARCHAR2(200),
  sign_tm                        DATE
)
tablespace USERS
  pctfree 10
...
(
  id                     VARCHAR2(200) not null,
  opc_registration_id    VARCHAR2(200),
  ordered_date           DATE,
  ordered_dept_id        VARCHAR2(200),
  ordered_doctor_id      VARCHAR2(200),
  s_cflb_dm              VARCHAR2(2),
  s_cfsx_dm              VARCHAR2(2),
  s_kdxxly_dm            VARCHAR2(2),
  pharmacy_code          VARCHAR2(200),
  presc_no               VARCHAR2(200),
  input_person_id        VARCHAR2(200),
  input_date             TIMESTAMP(6),
  charge_dept_id         VARCHAR2(200) not null,
  charge_person_id       VARCHAR2(200),
  charge_date            TIMESTAMP(6),
  drug_presc_h_id        VARCHAR2(200),
  is_antibiosis_presc    CHAR(1),
  settlement_times       INTEGER,
  settlement_dept_id     VARCHAR2(200),
  settlement_person_id   VARCHAR2(200),
  settlement_date        DATE,
  ordered_area_id        VARCHAR2(200),
  ordered_office_dept_id VARCHAR2(200),
  patient_type_id        VARCHAR2(200),
  insurance_area_code    VARCHAR2(50),
  insurance_area_name    VARCHAR2(50),
  win_config_infoset     VARCHAR2(200),
  op_dept_id             VARCHAR2(200),
  op_person_id           VARCHAR2(200),
  op_date                DATE,
  arrears_reason         VARCHAR2(200),
  s_jmyy_dm              VARCHAR2(200),
  exam_person_id         VARCHAR2(200),
  health_service_org_id  VARCHAR2(200) default 'RSS20110919001863000',
  ivf_cmrs_id            VARCHAR2(32),
  is_nfd                 CHAR(1),
  is_insin               CHAR(1),
  is_external_fit        CHAR(1),
  is_cnv_presc           CHAR(1),
  ordrset_no             VARCHAR2(200),
...
(
  id                      VARCHAR2(200) not null,
  drug_presc_h_charge_id  VARCHAR2(200),
  drug_id                 VARCHAR2(200) not null,
...
(
  ...
  ordered_doctor_id      VARCHAR2(200),
  s_kdxxly_dm            VARCHAR2(2),
  appliction_no          VARCHAR2(200),
  input_person_id        VARCHAR2(200),
  input_date             TIMESTAMP(6),
  charge_dept_id         VARCHAR2(200) not null,
  charge_person_id       VARCHAR2(200),
  charge_date            TIMESTAMP(6),
  diag_service_h_id      VARCHAR2(200),
  settlement_times       INTEGER,
  settlement_dept_id     VARCHAR2(200),
  settlement_person_id   VARCHAR2(200),
  settlement_date        DATE,
  ...
  health_service_org_id  VARCHAR2(200) default 'RSS20110919001863000',
  ivf_cmrs_id            VARCHAR2(32),
  barcode_no             VARCHAR2(200),
  oit_it_exec_id         VARCHAR2(200),
  is_insin               CHAR(1),
  ordrset_no             VARCHAR2(200),
  biz_btch_trans_no      VARCHAR2(32)
)
...
(
  id                       VARCHAR2(200) not null,
  diag_service_h_charge_id VARCHAR2(200),
  diag_item_id             VARCHAR2(200) not null,
  ...
  exec_dept_id             VARCHAR2(200),
  exec_person_id           VARCHAR2(200),
  out_patient_charge_type  VARCHAR2(2),
  invoice_no               VARCHAR2(200),
  checkout_vouchar_no      VARCHAR2(30),
  diag_service_d_charge_id VARCHAR2(200),
  package_qty              INTEGER,
  opc_diag_service_d_id    VARCHAR2(200),
  primary_barcode          VARCHAR2(100),
  trace_barcode            VARCHAR2(100),
  ext_trans_code           VARCHAR2(30),
  discount_amt             NUMBER(15,8),
  pem_exam_chargeitem_id   VARCHAR2(200),
  ...
  op_pers_id               VARCHAR2(200),
  op_asst_i_pers_id        VARCHAR2(200),
  op_asst_ii_pers_id       VARCHAR2(200),
  op_kpi                   NUMBER(15,4),
  op_asst_i_kpi            NUMBER(15,4),
  op_asst_ii_kpi           NUMBER(15,4),
  s_fbdj_dm                VARCHAR2(2),
  use_fee_lvl              VARCHAR2(2),
  op_asst_iii_pers_id      VARCHAR2(200),
  op_asst_iv_pers_id       VARCHAR2(200),
...
(
  id                      VARCHAR2(200) not null,
  person_info_id          VARCHAR2(200) not null,
  ...
  s_hyzk_dm               VARCHAR2(2) not null,
  person_ident_id         VARCHAR2(200),
  patient_type_id         VARCHAR2(200) not null,
  s_czbz_dm               VARCHAR2(1) default '1',
  health_service_org_id   VARCHAR2(200) default 'RSS20110919001863000' not null,
  registration_person_id  VARCHAR2(200),
  registration_date       DATE,
  opc_registration_id     VARCHAR2(200),
  opc_dept_id             VARCHAR2(200),
  clinic_dept_id          VARCHAR2(200),
  opc_doctor_id           VARCHAR2(200),
  ipi_dept_id             VARCHAR2(200) not null,
  ipi_doctor_id           VARCHAR2(200) not null,
  dept_id                 VARCHAR2(200),
  dept_director_id        VARCHAR2(200),
  doctor_id               VARCHAR2(200),
  nurse_id                VARCHAR2(200),
  bed_id                  VARCHAR2(200),
  bed_no                  VARCHAR2(10),
  s_hllx_dm               VARCHAR2(1),
  s_hldj_dm               VARCHAR2(1),
  ipi_registration_no     VARCHAR2(11),
  health_insurance_id     VARCHAR2(200),
  pre_service_date        DATE,
  is_newbom_baby          CHAR(1),
  is_baby_detained        CHAR(1),
  baby_link_ipi_no        VARCHAR2(200),
  ...
  s_ylfkfs_dm             VARCHAR2(2),
  ipi_reg_certificate_id  VARCHAR2(200),
  ipi_reg_app_id          VARCHAR2(200),
  is_pregnancy            CHAR(1),
  is_gcp                  CHAR(1),
  age_hh                  INTEGER,
  age_ss                  INTEGER,
  ...
  gab                     NUMBER(3),
  bbl                     NUMBER(5,1),
  midwife_id              VARCHAR2(200),
  clinic_group_id         VARCHAR2(200),
  migrate_sys_id          VARCHAR2(32),
  is_self_settlement      CHAR(1),
  s_pkhsx_dm              VARCHAR2(4),
  s_gllx_dm               VARCHAR2(2),
  head_nurse_id           VARCHAR2(200),
  is_gc                   CHAR(1),
  is_psycho               CHAR(1),
  ...
  s_scqd_dm               VARCHAR2(200),
  workunit_province       VARCHAR2(200),
  workunit_city           VARCHAR2(200),
  workunit_area           VARCHAR2(200),
  workunit                VARCHAR2(140),
  nativeplace_area        VARCHAR2(200),
  inhospital_times        INTEGER,
  case_serialnumber       VARCHAR2(32),
  inhosp_way_othr         VARCHAR2(100),
  othr_hso_xfer           VARCHAR2(100),
  insection_dept_id       VARCHAR2(200),
  insection_user_id       VARCHAR2(200)
)
tablespace USERS
  pctfree 10
  initrans 1
...
(
  ...
  patient_type_id         VARCHAR2(200) not null,
  s_czbz_dm               VARCHAR2(1) default '1',
  health_service_org_id   VARCHAR2(200) not null,
  registration_person_id  VARCHAR2(200),
  registration_date       DATE,
  opc_registration_id     VARCHAR2(200),
  opc_dept_id             VARCHAR2(200),
  clinic_dept_id          VARCHAR2(200),
  opc_doctor_id           VARCHAR2(200),
  ipi_dept_id             VARCHAR2(200),
  ipi_doctor_id           VARCHAR2(200),
  dept_id                 VARCHAR2(200),
  dept_director_id        VARCHAR2(200),
  doctor_id               VARCHAR2(200),
  nurse_id                VARCHAR2(200),
