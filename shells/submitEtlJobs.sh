...
topics=(OPR_REGISTRATION OPC_DIAG_SERVICE_D_CHARGE OPC_DRUG_PRESC_D_CHARGE OPC_DRUG_PRESC_H_CHARGE OPC_DIAG_SERVICE_H_CHARGE IPI_REGISTRATION HRA00_DEPARTMENT PUB_HLLX)
